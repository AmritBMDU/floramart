            ...
            <div className="banner-area banner-area1 pos-rel">
                <div className="swiper-container slider__active">
                    <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide">
                            <div className="single-banner single-banner-1 banner-800 d-flex align-items-center pos-rel">
                                <div className="banner-bg banner-bg1 banner-bg1-1" data-background="assets/img/banner/banner1.jpg">
                                </div>
                                <div className="container pos-rel">
                                    <div className="row align-items-center">
                                        <div className="col-lg-8 col-md-8">
                        ...
                        <div className="swiper-slide">
                            <div className="single-banner single-banner-1 banner-800 d-flex align-items-center pos-rel">
                                <div className="banner-bg banner-bg1 banner-bg1-1" data-background="assets/img/banner/banner2.jpg">
                                </div>
                                <div className="container pos-rel">
                                    <div className="row align-items-center">
                                        <div className="col-lg-8 col-md-8">
