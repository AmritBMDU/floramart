                        ...
                        <tbody>
                           <tr>
                              <td className="product-thumbnail"><a href="shop-details.html"><img
                                       src="assets/img/shirt/3/1.jpg" alt="img"/></a></td>
                              <td className="product-name"><a href="shop-details.html">Felted Shirt for Man</a></td>
                           ...
                           <tr>
                              <td className="product-thumbnail"><a href="shop-details.html"><img
                                       src="assets/img/pant/1/4.jpg" alt="img"/></a></td>
                              <td className="product-name"><a href="shop-details.html">Denim Jeans Pant</a>
                              </td>
                           ...
                           <tr>
                              <td className="product-thumbnail"><a href="shop-details.html"><img
                                       src="assets/img/jacket/2/2.jpg" alt="img"/></a></td>
                              <td className="product-name"><a href="shop-details.html">Denim Official Jacket</a></td>
                     ...
                     <div className="col-12">
                        <div className="coupon-all">
                           ...
                           <div className="coupon2">
                              <button onclick="window.location.reload()" className="fill-btn" name="update_cart"
                  ...
                  <div className="row">
                     <div className="col-md-5 ml-auto">
                        <div className="cart-page-total">
                           ...
                           <a className="border-btn" href="checkout.html">Proceed to checkout</a>
                        </div>
                     </div>
                  </div>
               </div>
